...
export const { addNowPlayingMovies, addMoviesToWatch, addTrailerVideo, addTrendingMovies, addPopularMovies, addTrendingShows, addTrendingContent, addMovieForDisplay } = movieSlice.actions;
