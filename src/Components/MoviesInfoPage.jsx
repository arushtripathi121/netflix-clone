...
const MoviesInfoPage = () => {
    ...
    return (
        <div className='browse aspect-video px-4 py-4 md:px-20 md:py-10 bg-gray-900'>
            <Link to={'/browse'}>
                <p className='mb-10'>
            ...
            <div className='border border-gray-500 text-white flex flex-col md:flex-row gap-6 p-5 rounded-lg'>
                ...
                <div className='flex flex-col items-start text-white space-y-5 w-full'>
                    ...
                    <div className='flex flex-col space-y-2'>
                        <p className={`px-3 py-1 rounded-full ${adult ? 'bg-green-600' : 'bg-red-600'}`}>{!adult ? '18+' : '13+'}</p>
                    ...
                    <Link to={'/player'}><button className='px-5 py-3 bg-red-700 rounded-lg hover:bg-red-600 transition-colors'>
